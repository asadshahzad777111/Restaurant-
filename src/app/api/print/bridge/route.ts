...
import { printBridgePublic, readPrintBridge, touchPrintBridge } from "@/lib/print-bridge";

export const runtime = "nodejs";

/** GET /api/print/bridge — HQ/POS: "Android printer: connected" for this tenant only. */
export async function GET(req: NextRequest) {
  try {
    ...
    const presence = await readPrintBridge(session.tenantId!);
